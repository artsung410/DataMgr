...
public class EnemyAI : MonoBehaviour
{
    ...
    void randomGameDataSaveAndLoad()
    {
        GameData randGameData = DataMgr.Instance.GameData;
        int randPlayerGold = Random.Range(100, 301);
        int randPlayerHp = Random.Range(300, 1001);
        float randPlayerSpeed = Random.Range(1.0f, 6.0f);

        float randMosnter1Speed = Random.Range(1.0f, 2f);
        float randMosnter1RSpeed = Random.Range(1.0f, 2f);
        float randMosnter2Speed = Random.Range(3.0f, 6.0f);
        float randMosnter2RSpeed = Random.Range(3.0f, 6.0f);

        randGameData.gold = randPlayerGold;
        randGameData.hp = randPlayerHp;
        randGameData.moveSpeed = randPlayerSpeed;

        if (randGameData.monsterKillDatas.Count !=0 )
        {
            randGameData.monsterKillDatas.Clear();
        }

        randGameData.monsterKillDatas.Add(new MonsterData(1, "일반 스켈레톤", randMosnter1Speed, randMosnter1RSpeed, "ㅋㅋㅋ"));
        randGameData.monsterKillDatas.Add(new MonsterData(2, "레드 스켈레톤", randMosnter2Speed, randMosnter2RSpeed, "???"));
